defmodule Dashed.InputParsers.StringInputParserTest do
  @moduledoc false
  @moduledoc since: "0.0.0"

  use ExUnitHelpers

  @input_parser_module Dashed.InputParsers.StringInputParser

  describe "parse/2" do
    test "it should parse the correct value" do
      assert @input_parser_module.parse("username:dashed test asdf") ==
               "username:dashed test asdf"
  ...
  test "it should return the correct data types" do
    assert @input_parser_module.supported_data_types() == ~w(string)a
  end
